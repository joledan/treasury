...
- per_investor_value_in_mln_us = value of the deal for each FI involved (assumed, e.g. how much does HSBC specifically get from this deal) 
...
Using these key relationships, we can replicate the values that appear in the visuals in the report.
